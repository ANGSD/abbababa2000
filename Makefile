...
victor: $(OBJ)
	$(CXX) $(FLAGS)  -o victor *.o $(HTS_LIBDIR) -lz -lm -lbz2 -llzma -lpthread -lcurl -D__WITH_BCF__
else
%.o: %.cpp
...
victor: $(OBJ)
	$(CXX) $(FLAGS)  -o victor *.o -lz -lpthread -lhts  -lbz2 -llzma 
endif
